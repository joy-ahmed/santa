...
describe('pairings', () => {
  ...
  scenario('creates a pairing', async (scenario: StandardScenario) => {
    const result = await createPairing({
      input: {
        ...
        updatedAt: '2023-12-21T14:21:33.737Z',
      },
    })
    ...
    expect(result.updatedAt).toEqual(new Date('2023-12-21T14:21:33.737Z'))
  })
  ...
  scenario('updates a pairing', async (scenario: StandardScenario) => {
    ...
    const result = await updatePairing({
      id: original.id,
      input: { updatedAt: '2023-12-22T14:21:33.737Z' },
    })

    expect(result.updatedAt).toEqual(new Date('2023-12-22T14:21:33.737Z'))
  })
