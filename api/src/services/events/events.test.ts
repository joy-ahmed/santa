...
describe('events', () => {
  ...
  scenario('creates a event', async () => {
    const result = await createEvent({
      input: {
        name: 'String',
        date: '2023-12-21T14:21:14.339Z',
        updatedAt: '2023-12-21T14:21:14.339Z',
      },
    })

    expect(result.name).toEqual('String')
    expect(result.date).toEqual(new Date('2023-12-21T14:21:14.339Z'))
    expect(result.updatedAt).toEqual(new Date('2023-12-21T14:21:14.339Z'))
  })
